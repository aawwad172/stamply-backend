...
- **Simplified Management:** The management interface for business owners must be intuitive and easy to use, regardless of their technical expertise. Prioritize clarity and ease of navigation.
- **Mobile-First Design:** Since the primary interaction happens on mobile devices (wallets and QR scanning), the design and UX must be optimized for mobile interactions first.

## Prose Style
- **Simple & Direct:** Use clear, straightforward language. Avoid jargon and complex terminology.
- **Active Voice:** Use the active voice to make instructions and feedback feel immediate and actionable.
- **Consistency:** Ensure consistent terminology across the entire application and all documentation.
